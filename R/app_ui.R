...
app_ui <- function() {
  ...
  # Header definition
  header <- shinydashboardPlus::dashboardHeader(title = span("advancedShiny", tags$img(src = "img/rockets.png", height = 50), class = "sidebar-title"))
  ...
  ui <- shinydashboardPlus::dashboardPage(title = "advancedShiny",
                                          header = header,
                                          sidebar = sidebar,
                                          body = body)
